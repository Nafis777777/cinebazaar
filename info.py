...
BOT_TOKEN = environ.get('BOT_TOKEN', "7274016083:AAGs5KhTl7pU4EHnsmYlIDSXSddw4jdyZGc")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 1800))
PICS = (environ.get('PICS', 'https://ibb.co.com/qnCfz25')).split() #SAMPLE PIC
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7019194522 5790252632 6872031220').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002475744052').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '7019194522').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '5790252632')
...
COLLECTION_NAME = environ.get('COLLECTION_NAMETcinebazaar')
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'nafiz555') # owner username without @
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/CineDramaGroup')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/CineDrama')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Netflix_Dramas')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'CineDramaGroup') # Support Chat Link Without https:// or @
...
MSG_ALRT = environ.get('MSG_ALRT', 'Welcome To CineDrama ❤️')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "sufficient-zahara-cinedrama-cb555493.koyeb.app/")
